...
Java_com_quentin_securebank_MainActivity_API(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_quentin_securebank_MainActivity_API2(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_quentin_securebank_MainActivity_ID(
        JNIEnv* env,
        jobject /* this */) {
    std::string id = "1";
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_quentin_securebank_MainActivity_Key(
        JNIEnv* env,
        jobject /* this */) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_com_quentin_securebank_MainActivity_MasterKey(
        JNIEnv* env,
        jobject /* this */) {
